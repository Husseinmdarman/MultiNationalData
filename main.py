...
def datetime_table_init():
    """
    Initiliases the date-time table
    """
...
def card_details_table_init():
    """
    Initiliases the card details table
    """
...
def store_details_init():
    """
    Initiliases the store details table
    """
